...
export default function Nav() {
  return (
    <div className="relative z-10 px-4 pt-5 md:pt-6">
      <nav className="mobile-safe-shell mx-auto flex max-w-6xl items-center justify-between gap-2 rounded-full border border-white/10 bg-white/[0.04] backdrop-blur-xl px-3 py-3 sm:px-5 lg:px-6">
        <Logo light width={66} />
