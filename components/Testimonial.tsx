  ...
  return (
    <section className="bg-[#F2DDD8] py-24 px-4 text-center">
      <motion.div
        ...
        className="mx-auto max-w-4xl flex flex-col items-center gap-7"
      >
        <motion.div variants={fadeUp} className="text-[#C4973F] text-2xl tracking-widest">★★★★★</motion.div>
        <motion.blockquote variants={fadeUp} className="font-display font-black italic text-3xl md:text-5xl lg:text-6xl leading-[1.1] tracking-[-0.03em] text-[#1A1814]">
